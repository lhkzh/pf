...
import {wx_mini} from "./wx_mini";
import {Multipart} from "fibjs-multipart";

const crypto_util = wx_mini.crypto_util;
type wx_base_api_res = wx_mini.wx_base_api_res;
type wx_ClientInfo = wx_mini.wx_ClientInfo;

/**
 * QQ小游戏相关接口
 */
export module qq_mini {
