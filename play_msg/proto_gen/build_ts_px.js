...
function is_privimite_arr(type) {
  return (
    "Int8Array,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array,BigInt64Array,BigUint64Array".indexOf(
      type
    ) > -1
  );
}
    ...
    if (e.type.indexOf(">") > 0) {
      ...
      if (t0 == "arr" || t0 == "set") {
        ...
        if (bases.indexOf(t1.toUpperCase()) > -1) {
          ...
          var _rtpl = `        coder.arrSize(this.${e.name}.${_len}, stream);
