...
export class Facade {
    ...
    //msgpack 编码代理
    public static _msgpack: { encode: (d: any) => any, decode: (b: Class_Buffer | Uint8Array) => any };
    //xml 编码代理
...
try {
    Facade._msgpack = require("msgpack");
} catch (e) { }
try {
    Facade._xml = {
        encode: require("pf_xml").objToXmlNoAttr,
        decode: require("pf_xml").xmlToObjNoAttr
    };
} catch (e) { }
